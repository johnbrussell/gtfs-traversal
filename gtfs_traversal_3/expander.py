...
class Expander:
    ...
    def _get_next_stop_data_for_trip(self, location_status):
        ...
        new_unvisited = self._get_new_unvisited(location_status.unvisited, location_status.location, next_stop, location_status.arrival_trip, duration)
