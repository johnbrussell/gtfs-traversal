...
class TestSolver(unittest.TestCase):
    ...
    def test_get_nodes_after_transfer(self):
        ...
        with patch.object(Traverser, 'get_walking_data', return_value=['walking data']) as mock_walking_data:
            with patch.object(Traverser, 'get_node_after_boarding_route', return_value='new route data') \
