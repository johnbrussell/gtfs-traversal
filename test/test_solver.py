...
class TestSolver(unittest.TestCase):
    def test_walk_time_seconds(self):
        def get_solver_with_speed(*, mph):
            return Solver(
                analysis=None,
                initial_unsolved_string=None,
                location_routes=None,
                max_expansion_queue=None,
                max_progress_dict=None,
                minimum_stop_times=None,
                off_course_stop_locations=None,
                route_stops=None,
                route_trips=None,
                stop_join_string=None,
                stop_locations_to_solve=None,
                stops_at_ends_of_solution_routes=None,
                total_minimum_time=None,
